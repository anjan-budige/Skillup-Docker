    ...
    />
            ...
            <Modal isOpen={modalState.type === 'add' || modalState.type === 'edit'} onClose={closeModal} title={modalState.type === 'add' ? 'Create New Course' : 'Edit Course'}>
                <form onSubmit={handleFormSubmit} className="space-y-6">
                    ...
                    <AssignableMultiSelect type="faculty" placeholder="Search faculty by name..." selectedItems={formData.faculty || []} onSelectionChange={(items) => handleMultiSelectChange('faculty', items)} />
                    <AssignableMultiSelect type="batch" placeholder="Search batches by name..." selectedItems={formData.batches || []} onSelectionChange={(items) => handleMultiSelectChange('batches', items)} />
